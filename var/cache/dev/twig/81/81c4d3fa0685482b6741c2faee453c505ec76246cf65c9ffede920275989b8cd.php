...
class __TwigTemplate_e3e36b1cf1527be75b353639eadb33d7698c6828275ee51b1311b81aa3d899ac extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 20
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["comment"]) || array_key_exists("comment", $context) ? $context["comment"] : (function () { throw new RuntimeError('Variable "comment" does not exist.', 20, $this->source); })()), "authorName", [], "any", false, false, false, 20), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>CreatedAt</th>
...
{% endblock %}
", "comment/show.html.twig", "C:\\Users\\Admin\\Desktop\\pii\\pidev\\templates\\comment\\show.html.twig");
    }
}
