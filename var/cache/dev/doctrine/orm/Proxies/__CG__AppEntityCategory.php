...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'type', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'produits'];
        }
     ...
     * {@inheritDoc}
     */
    public function setType(string $type): \App\Entity\Category
    {
