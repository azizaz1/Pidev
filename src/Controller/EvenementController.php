...
{
    /**
     * @Route("/getaway/evenement", name="evenement")
     */
    ...
    /**
     * @Route("/getaway/evenement/list", name="liste")
     */
    ...
    /**
     * @Route("/getaway/evenement/delete/{id}", name="deletee")
     */
    ...
    /**
     * @Route("/getaway/evenement/add", name="adde")
     */
    ...
    /**
     * @Route("/getaway/evenement/update/{id}", name="updatee")
     */
