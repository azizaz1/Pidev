 ...
 */
final class Version20220220215159 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participation ADD participation_id INT NOT NULL');
        $this->addSql('ALTER TABLE participation ADD CONSTRAINT FK_AB55E24F6ACE3B73 FOREIGN KEY (participation_id) REFERENCES events (id)');
        $this->addSql('CREATE INDEX IDX_AB55E24F6ACE3B73 ON participation (participation_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participation DROP FOREIGN KEY FK_AB55E24F6ACE3B73');
        $this->addSql('DROP INDEX IDX_AB55E24F6ACE3B73 ON participation');
        $this->addSql('ALTER TABLE participation DROP participation_id, CHANGE nom nom VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE prenom prenom VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE adresse adresse VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
